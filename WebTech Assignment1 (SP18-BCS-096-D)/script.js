     ...
     function readData() {
         ...
         formData["get_gender"] = document.querySelector('input[name = gender]:checked').value;
         formData["get_age"] = document.getElementById("age").value;
         formData["get_city"] = document.getElementById("city").value;
         return formData;
     }
     ...
     function updateRow(td) {
         ...
         document.querySelector('input[name = gender].checked').value = selectedRow.cells[1].innerHTML;
     ...
     function updateRowEvent(readRowdata) {
         ...
         selectedRow.cells[3].innerHTML = readRowdata.get_city;
     }
